...
import ShowcaseProducts2 from "../Showcases/ShowcaseProducts2";
import "./JunctionDesktop.css";

const JunctionDesktop = () => {
  const settings = {
    infinite: true,
    speed: 500,
    slidesToShow: 2,
  ...
  return (
    <section className="container-junction-desktop">
      <div>
        <Banner2 />
      </div>
      <div>
            ...
            {dataSapatella
              ...
              .showcaseProducts1.map(
                (
                  ...
                  <div
                    key={index}
                    className="container-card-vitrini-products-2"
                  >
...
export default JunctionDesktop;
